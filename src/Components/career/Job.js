        ...
        <div className="container">
          <div className="row justify-content-center">
            <div className="col-sm-11 jobs_ul">
              ...
              <p className="mt-3">
                We are looking for a few software engineers (interns) to join
                the engineering team. Interested candidates are invited to
                submit CVs after reading the following job description.
              </p>
              ...
              <ul>
                ...
                <li>
                  ...
                  Babel, Webpack, NPM, etc. is a plus.
                </li>
              </ul>
              ...
              <ul>
                ...
                <li>
                  Starting salary will be 25,000 BDT/Month after the successful
